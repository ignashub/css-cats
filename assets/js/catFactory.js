...
function earsAndPaw(color, code) {
  $(
    ".cat__ear--left, .cat__ear--right, .cat__paw-left, .cat__paw-right,  .cat__paw-left_inner, .cat__paw-right_inner"
  ).css("background", "#" + color);
...
function eyeVariation(num) {
  ...
  switch (num) {
    ...
    case 4:
      normalEyes();
      $("#eyeshapecode").html("Watching");
      return eyesType3();
      break;
    case 5:
      normalEyes();
      $("#eyeshapecode").html("Night eyes");
      return eyesType4();
      break;
    case 6:
      normalEyes();
      $("#eyeshapecode").html("Wonder down");
      return eyesType5();
      break;
    case 7:
      normalEyes();
      $("#eyeshapecode").html("Wonder up");
      return eyesType6();
      break;
    case 8:
      normalEyes();
      $("#eyeshapecode").html("Circle");
      return eyesType7();
      break;
  }
}
...
function decorationVariation(num) {
  ...
  switch (num) {
    case 1:
      ...
      break;
    case 2:
      $("#decorationcode").html("Inverted");
      decorationType1();
      break;
    case 3:
      $("#decorationcode").html("Twisted");
      decorationType2();
      break;
    case 4:
      $("#decorationcode").html("Uniform");
      decorationType3();
      break;
    case 5:
      $("#decorationcode").html("Uniform twist");
      decorationType4();
      break;
    case 6:
      $("#decorationcode").html("Tribal");
      decorationType5();
      break;
    case 7:
      $("#decorationcode").html("Propeller");
      decorationType6();
      break;
    case 8:
      $("#decorationcode").html("Single");
      decorationType7();
      break;
  }
}
...
function animationVariation(num) {
  ...
  switch (num) {
    ...
    case 3:
      ...
      break;
    case 4:
      $("#animationcode").html("Left Ear");
      leftEar();
      break;
    case 5:
      $("#animationcode").html("Right Ear");
      rightEar();
      break;
    case 6:
      $("#animationcode").html("Attentive");
      attentiveCat();
      break;
  }
}
...
function eyesType3() {
  $(".cat__eye")
    .find("span")
    .css({ "border-top": "15px solid", "border-bottom": "15px solid" });
}
...
function eyesType4() {
  $(".cat__eye")
    .find("span")
    .css({ "border-right": "15px solid", "border-left": "15px solid" });
}

//Right left top
function eyesType5() {
  $(".cat__eye").find("span").css({
...
function decorationType3() {
  normaldecoration();
  $(".cat__head-dots, .cat__head-dots_first, .cat__head-dots_second").css({
    height: "40px",
    width: "20px",
  });
}
...
document.addEventListener(
  ...
  (e) => {
    ...
    document.querySelector(".pupil-left").style.transform =
      "translate(" + moveX + "px," + moveY + "px)";
    document.querySelector(".pupil-right").style.transform =
      "translate(" + moveX + "px," + moveY + "px)";
